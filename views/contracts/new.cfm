	...
	<div class="row justify-content-center">
		<div class="col-md-8">
			<div class="d-flex justify-content-between align-items-center mb-4">
				<h1><i class="bi bi-plus-lg"></i> New Contract</h1>
			...
			<div class="card">
				<div class="card-body">
					<form method="POST" action="#event.buildLink( 'contracts' )#">
						<div class="mb-3">
						...
						<div class="d-flex gap-2">
							<button type="submit" class="btn btn-primary">
								<i class="bi bi-check-lg"></i> Create Contract
							</button>
							<a href="#event.buildLink( 'contracts' )#" class="btn btn-outline-secondary">Cancel</a>
						</div>
					</form>
				</div>
			</div>
