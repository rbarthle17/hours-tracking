	...
	<div class="row justify-content-center">
		<div class="col-md-8">
			<div class="d-flex justify-content-between align-items-center mb-4">
				<h1><i class="bi bi-plus-lg"></i> New Expense</h1>
			...
			<div class="card">
				<div class="card-body">
					<form method="POST" action="#event.buildLink( 'expenses' )#"
						  x-data="{ isBillable: #( rc.is_billable ?: '0' ) EQ '1' ? 'true' : 'false'# }">

						<div class="row mb-3">
							<div class="col-md-6">
								<label for="expense_date" class="form-label">Date <span class="text-danger">*</span></label>
								<input type="date" class="form-control" id="expense_date" name="expense_date"
									   value="#encodeForHTMLAttribute( rc.expense_date ?: dateFormat( now(), 'yyyy-mm-dd' ) )#" required>
							</div>
							<div class="col-md-6">
								...
								<div class="input-group">
									...
									<input type="number" class="form-control" id="amount" name="amount"
										   value="#encodeForHTMLAttribute( rc.amount ?: '' )#"
						...
						<div class="row mb-3">
							<div class="col-md-6">
								...
								<input type="text" class="form-control" id="vendor" name="vendor"
									   value="#encodeForHTMLAttribute( rc.vendor ?: '' )#" required>
							</div>
							<div class="col-md-6">
							...
							<select class="form-select" id="client_id" name="client_id"
								...
								<cfloop query="prc.clients">
									<option value="#prc.clients.id#"
											#val( rc.client_id ?: 0 ) EQ prc.clients.id ? 'selected' : ''#>
						...
						<div class="mb-3">
							...
							<textarea class="form-control" id="description" name="description"
									  rows="3">#encodeForHTML( rc.description ?: '' )#</textarea>
						</div>
						...
						<div class="mb-3">
							...
							<input type="text" class="form-control" id="receipt_reference" name="receipt_reference"
								   value="#encodeForHTMLAttribute( rc.receipt_reference ?: '' )#"
						...
						<div class="d-flex gap-2">
							...
							<a href="#event.buildLink( 'expenses' )#" class="btn btn-outline-secondary">Cancel</a>
						</div>
					</form>
				</div>
			</div>
